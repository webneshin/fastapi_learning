from fastapi import Path, Query, status, HTTPException, Request, Depends, APIRouter
...
# app ##################################################################################################################
@router.get("/01_app/get_method")
async def get_method():
    return "this is 'get' method"


@router.post("/01_app/post_method")
async def post_method():
    return "this is 'post' method"


@router.put("/01_app/put_method")
async def put_method():
    return "this is 'put' method"


# parameters ###########################################################################################################
@router.get("/02_parameters/path_parameters/{name}/{age}")
async def path_parameter(name: str, age: int):
    return {"message": f"{name} is {age} years old.."}


@router.get("/02_parameters/query_parameters/{name}")
...
@router.post("/03_request_body/user")
...
@router.post("/04_query_path/user")
...
@router.post("/05_response_model/user", response_model=UserMe, status_code=status.HTTP_201_CREATED)
...
@router.get("/06_template/home", response_class=HTMLResponse)
